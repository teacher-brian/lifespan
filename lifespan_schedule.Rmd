---
title: "Lifespan Schedule Winter 2023"
author: "Brian Holt"
date: "`r Sys.Date()`"
output:
  html_document:
...
That's the kind of question you can put in your one-document-to-rule, or even ask questions on the [muddy point channel](https://lifespanwinter23.slack.com/archives/C04H0J6S49L){target="_blank"}
...
1. Introduce yourself the Slack [#introductions](https://lifespanwinter23.slack.com/archives/C04H72ZP5BM){target="_blank"} channel
...
3. On the same google document, make a new page, title it, and write some thoughts down to the following prompts.  When you are done, post to the [#week_1](https://lifespanwinter23.slack.com/archives/C04H731GM99){target='_blank'} slack channel by including a link to your document from step 2 above.
...
A. Synthesize the following readings: @rappaportWILLIAMPERRYSCHEME2018, @schwartzImportanceStupidityScientific2008, then post your work to [#week-2](https://lifespanwinter23.slack.com/archives/C04H9KUHFDJ){target='_blank'}
...
E. When done, post to the slack channel [#week-3](https://lifespanwinter23.slack.com/archives/C04JUC7GP7F){target='_blank'}
...
## Do some stuff
 ...
 D. Post your work to [#week4](https://lifespanwinter23.slack.com/archives/C04KM1PHCAC){target='_blank'} channel.
...
5. [Panopto video, Reversibility](https://northseattle.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=11cced3d-878c-48ae-850d-ad1301556be1){target='_blank'}


6. Pick a chapter from one of the 4 volumes of the [Handbook of Developmental Psychology](https://www.wiley.com/en-us/Handbook+of+Child+Psychology+and+Developmental+Science%2C+Volume+2%2C+Cognitive+Processes%2C+7th+Edition-p-9781118136782){target='_blank'}
...
8. Read Nancy Chick, [Metacognition](https://cft.vanderbilt.edu/guides-sub-pages/metacognition/){target="_blank"}

9. Read  Alfie Kohn, [The Case Against Grades](https://www.alfiekohn.org/article/case-grades/){target="_blank"}
...
3.  Using the critical thinking standards try to find and evaluate some sources on the Intelligence quotient (IQ) and other measures of intellectual abilities.  Share your ideas in the [#intelligence-IQ channel](https://lifespanwinter23.slack.com/archives/C04R85HDDMG){target='_blank'}. Debate is welcome on this one.
