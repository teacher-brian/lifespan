...
There are several things to think about this week. And I'm probably giving you too much to do so I want you to be thoughtful about your limits + 2 focus on the things that interest you.

 my intention is to expose you to a few things here they are:

An introductory lecture two lifespan or developmental psychology in particular

And opportunity to peruse vocabulary from the first three chapters
...
[ 48 minutes Watch dev video from Bilkent University (Turkey) Hande Ilgaz, Ph.D.](https://www.youtube.com/watch?v=s3iDxvk7Cck){target='_blank'} @bilkentuniversitesiDevelopmentalPsychologyLecture2017 
    ...
    * there is a short segment in the video discussing the history of Thalidomide.  It's brutal.  

[Review William perry developmental stages as summarized by William Rappaport](https://cse.buffalo.edu/~rapaport/perry.positions.html){target='_blank'} @rappaportWILLIAMPERRYSCHEME2018
  


## Do some stuff

review your notes or the video on epistemology
