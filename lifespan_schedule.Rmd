...
5. Pick a chapter from one of the 4 volumes of the [Handbook of Developmental Psychology](https://www.wiley.com/en-us/Handbook+of+Child+Psychology+and+Developmental+Science%2C+4+Volumes%2C+Set%2C+7th+Edition-p-9781118136850#content-section){target='_blank'}
...
No reference though.  Possibly connects to Dobbs listed just above.  My quick check on that resource goes to a national geographic article.  That's weird.  And my knowledge of these sorts of claims comes from experience that most of those research claims are hypothetical, or based on other mamals.  
...
As you read the textbook, keep track of its claims that either don't have references, or give you the vibes that there is an oversimplication.
...
1. [Read Chapter 6, Adolescence](https://socialsci.libretexts.org/Bookshelves/Human_Development/Book%3A_Lifespan_Development_-_A_Psychological_Perspective_(Lally_and_Valentine-French)/04%3A_Early_Childhood){target='_blank'}

   * While reading, take some notes regarding textbook claims that might sounds to simple.  Keep track of their locations

2. Read chosen article from handbook volumne.  Okay..skim it, but find some sections that you find interesting. 
