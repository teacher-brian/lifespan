...
# Week 8  Middle adulthood May 26 {#week8}
...
1. Share your Grief walker assignment in the [#week 10 disc](https://canvas.seattlecolleges.edu/courses/32787/modules/items/1816789){target='_blank'}
...
3. Post your work on the case study and the cultural practices into [#week 11](https://canvas.seattlecolleges.edu/courses/32787/modules/items/1816795){target="_blank"}
...
```{block, type='instructorNote'}
Deadline for the quarter is Wednesday Jun 18, late evening.
```
